    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)//登入按鈕
        {
            ...
            {//系統登入
                ...
                connection.Open();
                string query = "SELECT CarerLogin.cAccount, Carer.cName FROM CarerLogin JOIN Carer ON CarerLogin.cId = Carer.cId WHERE CarerLogin.cAccount = @Account AND CarerLogin.cPassword = @Password";
