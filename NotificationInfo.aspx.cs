    ...
    public partial class NotificationInfo : System.Web.UI.Page
    {
        ...
        protected void BindGridView()
        {
            ...
            else if (Session["LoginType"] == "Home")
            {
                MySqlConnection connection = new MySqlConnection(connectionString);
                connection.Open();
                string query = "SELECT HomeElderFall.hfId as 跌倒編號,HomeElderFall.heId as 長者編號,HomeElder.heName as 長者姓名 ,HomeElderFall.hfPlace as 跌倒地點,HomeElderFall.hfTime as 跌倒時間, HomeElderFall.hfWhy as 跌倒原因 ,HomeElderFall.hId as 送醫 FROM HomeElderFall " +
